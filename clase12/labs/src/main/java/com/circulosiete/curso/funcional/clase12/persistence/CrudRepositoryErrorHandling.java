...
public class CrudRepositoryErrorHandling {
    ...
    public static <T, ID> Either<Failure<String, String>, T> save(CrudRepository<T, ID> repository, T entity) {
    ...
    private static <T, ID> Either<Failure<String, String>, T> internalSave(CrudRepository<T, ID> repository, T entity) {
